...
<body>
<center><h1>修改文章表</h1></center>

<form  action="{{url('/essay/update/'.$user->id)}}" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
	@csrf
	...
	<div class="form-group">
		...
		<div class="radio">
    <label>
        <input type="radio" name="important" id="optionsRadios1" value="1" @if($user->important==1) checked @endif>普通<br><br>
        <input type="radio" name="important" id="optionsRadios1" value="2" @if($user->important==2) checked @endif>置顶
	...
	<div class="form-group">
		...
		<div class="radio">
    <label>
        <input type="radio" name="show" id="optionsRadios1" value="1" @if($user->show==1) checked @endif>显示<br><br>
        <input type="radio" name="show" id="optionsRadios1" value="2" @if($user->show==2) checked @endif>不显示
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="people" id="firstname" 
				   placeholder="请输入文章作者" value="{{$user->people}}">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="email" id="firstname" 
				   placeholder="请输入作者email" value="{{$user->email}}">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="text" class="form-control" name="keyword" id="firstname" 
				   placeholder="请输入文章关键字" value="{{$user->keyword}}">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<textarea name="desc" value="{{$user->desc}}"></textarea>
		</div>
	</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			<input type="file" name="photo" class="form-control"  
				   >
			<img src="{{env('UPLOAD_URL')}}{{$user->photo}}" width="50" height="50">
		</div>
	</div>
	<div class="form-group">
		<div class="col-sm-offset-2 col-sm-10">
			<button type="button" class="btn btn-default">修改<tton>
		</div>
	</div>
</form>
</body>
